        ...
        <div className="bg-[#2ec4b6] dark:bg-[#161616] overflow- ">
            <div className="w-full block max-w-[100rem] mx-auto px-4 py-8 md:pb-24 ">
                ...
                <div className="flex flex-col md:flex-row items-center gap-5 md:gap-0 justify-between pt-18 text-black">
                    <ScrollAnimation from={-200} to={0} className="w-[18rem] h-[18rem] bg-[#cbf3f0] dark:bg-[#2ec4b6] p-4 text-center rounded-2xl">
                    ...
                    <ScrollAnimation yfrom={200} to={0} className="w-[18rem] h-[18rem] bg-[#cbf3f0] dark:bg-[#2ec4b6] p-6 text-center rounded-2xl">
                    ...
                    <ScrollAnimation from={200} to={0} className="w-[18rem] h-[18rem] bg-[#cbf3f0] dark:bg-[#2ec4b6] p-6 text-center rounded-2xl">
                        <div className="pl-12 -mt-3">
