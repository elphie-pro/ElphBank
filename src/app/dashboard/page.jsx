...
useEffect(() => {
  ...
  return (
    <motion.div variants={variants} initial="hidden" animate="show" className=' bg-white dark:bg-[#161616] w-full min-h-screen  flex flex-col md:flex-row'>
      <Sidebar />
      <div className="w-full block max-w-[100rem] mx-auto px-4 py-8 md:pb-1 pb-1">
